...
class hs(object):
    ...
    def __init__(self, lattice_spacing=None, z_line=None,
        ...
        self.titin = (
            ...
            ti.Titin(self, 3, ti_thick(1, 2), ti_thin(2, 1)),
            ti.Titin(self, 4, ti_thick(1, 3), ti_thin(3, 2)),
            ti.Titin(self, 5, ti_thick(1, 0), ti_thin(0, 2)),
            ti.Titin(self, 6, ti_thick(0, 4), ti_thin(4, 1)),
            ti.Titin(self, 7, ti_thick(0, 5), ti_thin(5, 0)),
            ti.Titin(self, 8, ti_thick(0, 6), ti_thin(6, 0)),
            ti.Titin(self, 9, ti_thick(1, 6), ti_thin(6, 1)),
            ti.Titin(self, 10, ti_thick(1, 7), ti_thin(7, 0)),
            ti.Titin(self, 11, ti_thick(1, 4), ti_thin(4, 0)),
            ti.Titin(self, 12, ti_thick(2, 5), ti_thin(5, 1)),
            ti.Titin(self, 13, ti_thick(2, 6), ti_thin(6, 2)),
            ti.Titin(self, 14, ti_thick(2, 7), ti_thin(7, 2)),
            ti.Titin(self, 15, ti_thick(3, 7), ti_thin(7, 1)),
            ti.Titin(self, 16, ti_thick(3, 4), ti_thin(4, 2)),
            ti.Titin(self, 17, ti_thick(3, 5), ti_thin(5, 2)),
            ti.Titin(self, 18, ti_thick(2, 1), ti_thin(1, 1)),
            ti.Titin(self, 19, ti_thick(2, 2), ti_thin(2, 0)),
            ti.Titin(self, 20, ti_thick(2, 3), ti_thin(3, 0)),
            ti.Titin(self, 21, ti_thick(3, 3), ti_thin(3, 1)),
            ti.Titin(self, 22, ti_thick(3, 0), ti_thin(0, 0)),
            ti.Titin(self, 23, ti_thick(3, 1), ti_thin(1, 0)),
        )
        ...
        # STILL NEED TO LINK FILAMENTS TO TITIN
